...
namespace GesFer.Admin.Back.Infrastructure.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IvaAmount = table.Column<decimal>(type: "decimal(18,4)", precision: 18, scale: 4, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_TaxType_Value", "`Value` >= 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Stock = table.Column<decimal>(type: "decimal(18,4)", precision: 18, scale: 4, nullable: false, defaultValue: 0m),
                    CreatedAt = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                    DeletedAt = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                    IsActive = table.Column<bool>(type: "tinyint(1)", nullable: false)
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Article_BuyPrice", "`BuyPrice` >= 0");
                    table.CheckConstraint("CK_Article_SellPrice", "`SellPrice` >= 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Email = table.Column<string>(type: "varchar(200)", maxLength: 200, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    SellTariffId = table.Column<Guid>(type: "char(36)", nullable: true, collation: "ascii_general_ci"),
                    PostalCodeId = table.Column<Guid>(type: "char(36)", nullable: true, collation: "ascii_general_ci"),
                    CityId = table.Column<Guid>(type: "char(36)", nullable: true, collation: "ascii_general_ci"),
                    StateId = table.Column<Guid>(type: "char(36)", nullable: true, collation: "ascii_general_ci"),
                    CountryId = table.Column<Guid>(type: "char(36)", nullable: true, collation: "ascii_general_ci"),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Customers_Tariffs_SellTariffId",
                        column: x => x.SellTariffId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Email = table.Column<string>(type: "varchar(200)", maxLength: 200, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    BuyTariffId = table.Column<Guid>(type: "char(36)", nullable: true, collation: "ascii_general_ci"),
                    PostalCodeId = table.Column<Guid>(type: "char(36)", nullable: true, collation: "ascii_general_ci"),
                    CityId = table.Column<Guid>(type: "char(36)", nullable: true, collation: "ascii_general_ci"),
                    StateId = table.Column<Guid>(type: "char(36)", nullable: true, collation: "ascii_general_ci"),
                    CountryId = table.Column<Guid>(type: "char(36)", nullable: true, collation: "ascii_general_ci"),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Suppliers_Tariffs_BuyTariffId",
                        column: x => x.BuyTariffId,
                        principalTable: "Tariffs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                })
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_TariffItem_Price", "`Price` >= 0");
                    table.ForeignKey(
                        name: "FK_TariffItems_Articles_ArticleId",
                        column: x => x.ArticleId,
                        principalTable: "Articles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TariffItems_Tariffs_TariffId",
                        column: x => x.TariffId,
                        principalTable: "Tariffs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SalesInvoiceId = table.Column<Guid>(type: "char(36)", nullable: true, collation: "ascii_general_ci"),
                    CreatedAt = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                    DeletedAt = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                    IsActive = table.Column<bool>(type: "tinyint(1)", nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Reference = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    BillingStatus = table.Column<int>(type: "int", nullable: false),
                    PurchaseInvoiceId = table.Column<Guid>(type: "char(36)", nullable: true, collation: "ascii_general_ci"),
                    CreatedAt = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                    DeletedAt = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                    IsActive = table.Column<bool>(type: "tinyint(1)", nullable: false)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PurchaseDeliveryNotes_PurchaseInvoices_PurchaseInvoiceId",
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci"),
                    SalesDeliveryNoteId = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci"),
                    ArticleId = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci"),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_SalesDeliveryNoteLine_Price", "`Price` >= 0");
                    table.CheckConstraint("CK_SalesDeliveryNoteLine_Quantity", "`Quantity` > 0");
                    table.ForeignKey(
                        name: "FK_SalesDeliveryNoteLines_Articles_ArticleId",
                        column: x => x.ArticleId,
                        principalTable: "Articles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci"),
                    PurchaseDeliveryNoteId = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci"),
                    ArticleId = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci"),
                    Quantity = table.Column<decimal>(type: "decimal(18,4)", precision: 18, scale: 4, nullable: false),
                    Price = table.Column<decimal>(type: "decimal(18,4)", precision: 18, scale: 4, nullable: false),
                    Subtotal = table.Column<decimal>(type: "decimal(18,4)", precision: 18, scale: 4, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_PurchaseDeliveryNoteLine_Price", "`Price` >= 0");
                    table.CheckConstraint("CK_PurchaseDeliveryNoteLine_Quantity", "`Quantity` > 0");
                    table.ForeignKey(
                        name: "FK_PurchaseDeliveryNoteLines_Articles_ArticleId",
                        column: x => x.ArticleId,
                        principalTable: "Articles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PurchaseDeliveryNoteLines_PurchaseDeliveryNotes_PurchaseDeli~",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Articles_CompanyId_Code",
                table: "Articles",
                columns: new[] { "CompanyId", "Code" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Customers_SellTariffId",
                table: "Customers",
                column: "SellTariffId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PurchaseDeliveryNoteLines_ArticleId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PurchaseDeliveryNotes_CompanyId_Date",
                table: "PurchaseDeliveryNotes",
                columns: new[] { "CompanyId", "Date" });

            migrationBuilder.CreateIndex(
                name: "IX_PurchaseDeliveryNotes_PurchaseInvoiceId",
                table: "PurchaseDeliveryNotes",
                column: "PurchaseInvoiceId");

            migrationBuilder.CreateIndex(
                name: "IX_PurchaseDeliveryNotes_Reference",
                table: "PurchaseDeliveryNotes",
                column: "Reference");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SalesDeliveryNoteLines_ArticleId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SalesDeliveryNotes_CompanyId_Date",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SalesDeliveryNotes_Reference",
                table: "SalesDeliveryNotes",
                column: "Reference");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TariffItems_ArticleId",
                table: "TariffItems",
                column: "ArticleId");

            migrationBuilder.CreateIndex(
                name: "IX_TariffItems_TariffId_ArticleId",
                table: "TariffItems",
                columns: new[] { "TariffId", "ArticleId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Tariffs_CompanyId_Name",
                table: "Tariffs",
                columns: new[] { "CompanyId", "Name" });

            migrationBuilder.CreateIndex(
                name: "IX_TaxTypes_CompanyId_Code",
                table: "TaxTypes",
                columns: new[] { "CompanyId", "Code" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_TaxTypes_CompanyId_Name",
                table: "TaxTypes",
                columns: new[] { "CompanyId", "Name" },
                unique: true);
