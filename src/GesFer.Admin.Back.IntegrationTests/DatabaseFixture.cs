...
{
    public IntegrationTestWebAppFactory<GesFer.Admin.Back.Api.Program> Factory { get; private set; } = null!;
    ...
    {
        Factory = new IntegrationTestWebAppFactory<GesFer.Admin.Back.Api.Program>();
