...
public class AdminLoginHandlerTests
{
    ...
    public async Task Handle_WithEmptyUsuario_ShouldReturnValidationError()
    {
        ...
        _mockAuthService.Verify(s => s.AuthenticateAsync(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<System.Threading.CancellationToken>()), Times.Never);
    ...
    public async Task Handle_WithInvalidCredentials_ShouldReturnAuthFailure_AndLogAudit()
    {
        ...
        _mockAuthService.Setup(s => s.AuthenticateAsync("invalid", "wrong", It.IsAny<System.Threading.CancellationToken>()))
    ...
    public async Task Handle_WithValidCredentials_ShouldReturnSuccess_AndLogAudit()
    {
        ...
        _mockAuthService.Setup(s => s.AuthenticateAsync("admin", "admin123", It.IsAny<System.Threading.CancellationToken>()))
