using GesFer.Admin.Back.Application.Commands.PurchaseDeliveryNote;
...
namespace GesFer.Admin.Back.Application.Handlers.PurchaseDeliveryNote;

/// <summary>
/// Handler para crear un albarán de compra
/// </summary>
public class CreatePurchaseDeliveryNoteCommandHandler : ICommandHandler<CreatePurchaseDeliveryNoteCommand, GesFer.Admin.Back.Domain.Entities.PurchaseDeliveryNote>
{
    ...
    public async Task<GesFer.Admin.Back.Domain.Entities.PurchaseDeliveryNote> HandleAsync(CreatePurchaseDeliveryNoteCommand command, CancellationToken cancellationToken = default)
    {
        ...
        // Crear el albarán
        var deliveryNote = new GesFer.Admin.Back.Domain.Entities.PurchaseDeliveryNote
        {
    ...
    /// </summary>
    private decimal GetPriceFromTariffOrArticle(GesFer.Admin.Back.Domain.Entities.Supplier supplier, Article article)
    {
