using GesFer.Admin.Back.Application.Commands.SalesDeliveryNote;
...
namespace GesFer.Admin.Back.Application.Handlers.SalesDeliveryNote;

/// <summary>
/// Handler para crear un albarán de venta
/// </summary>
public class CreateSalesDeliveryNoteCommandHandler : ICommandHandler<CreateSalesDeliveryNoteCommand, GesFer.Admin.Back.Domain.Entities.SalesDeliveryNote>
{
    ...
    public async Task<GesFer.Admin.Back.Domain.Entities.SalesDeliveryNote> HandleAsync(CreateSalesDeliveryNoteCommand command, CancellationToken cancellationToken = default)
    {
        ...
        // Crear el albarán
        var deliveryNote = new GesFer.Admin.Back.Domain.Entities.SalesDeliveryNote
        {
    ...
    /// </summary>
    private decimal GetPriceFromTariffOrArticle(GesFer.Admin.Back.Domain.Entities.Customer customer, Article article)
    {
