...
using GesFer.Admin.Back.Application.Handlers.PurchaseDeliveryNote;
using GesFer.Admin.Back.Application.Handlers.SalesDeliveryNote;
using GesFer.Admin.Back.Domain.Services;
using GesFer.Admin.Back.Infrastructure.Data;
using GesFer.Admin.Back.Domain.Services;
using GesFer.Admin.Back.Infrastructure.Repositories;
...
public static class DependencyInjection
{
    ...
    public static IServiceCollection AddApplicationServices(this IServiceCollection services, IConfiguration configuration, IWebHostEnvironment? environment = null)
    {
        ...
        else
        {
            ...
            services.AddHttpClient<IAdminApiClient, GesFer.Admin.Back.Infrastructure.Services.AdminApiClient>(client =>
            {
