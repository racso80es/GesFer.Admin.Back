...
namespace GesFer.Admin.Back.Api.Services;
...
public class SetupService : ISetupService
{
        ...
        try
        {
            ...
            try
            {
                using (var scope = _serviceProvider.CreateScope())
                {
                    ...
                    var masterDataSeeder = new GesFer.Admin.Back.Infrastructure.Services.MasterDataSeeder(
                        scope.ServiceProvider.GetRequiredService<ApplicationDbContext>(),
                        scope.ServiceProvider.GetRequiredService<ILogger<GesFer.Admin.Back.Infrastructure.Services.MasterDataSeeder>>(),
    ...
    private async Task SeedTestSuppliersAsync(ApplicationDbContext context, Guid companyId, Country? spain, ILogger logger)
    {
        try
        {
            ...
            var suppliers = new List<GesFer.Admin.Back.Domain.Entities.Supplier>
            {
                new GesFer.Admin.Back.Domain.Entities.Supplier
                {
    ...
    private async Task SeedTestCustomersAsync(ApplicationDbContext context, Guid companyId, Country? spain, ILogger logger)
    {
        try
        {
            ...
            var customers = new List<GesFer.Admin.Back.Domain.Entities.Customer>
            {
                new GesFer.Admin.Back.Domain.Entities.Customer
                {
