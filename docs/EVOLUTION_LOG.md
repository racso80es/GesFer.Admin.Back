...
[2026-02-20] [feat/skills-encapsulation] Encapsulamiento de skills (patrón tools): Cúmulo paths skills, SddIA/skills por carpeta, cápsulas scripts/skills, skills-rs (Rust), normas #Skill/#Action/#Process en SddIA/norms y AGENTS.norms.md. Documentación en docs/features/skills-encapsulation/. [PR pendiente]
