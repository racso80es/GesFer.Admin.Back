...
[2026-02-18] [feat/correccion-hallazgos-auditoria] Corrección de hallazgos de auditoría: referencias Shared dentro del repo, build y tests pasan. Documentación en docs/features/correccion-hallazgos-auditoria/. [PR pendiente]
