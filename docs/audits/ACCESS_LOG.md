...
| :---------- | :-------- | :------- | :------ |
| 2026-02-21  | finalize  | feat/correccion-segun-auditorias | Push a origin; PR #31 creado (https://github.com/racso80es/GesFer.Admin.Back/pull/31). Documentación en docs/features/correccion-segun-auditorias/. Validacion pass; Evolution Logs actualizados. |
