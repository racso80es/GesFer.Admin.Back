...
**Proceso:** feature  
**Persist:** docs/features/correccion-hallazgos-auditoria/ (Cúmulo.featurePath)  
...
| **documentation** | warn | Modo sin documentación: no existe {persist}. Cambios analizados por diff frente a rama base. |
...
3. **Documentation:** Esta feature tiene ya {persist} = docs/features/correccion-hallazgos-auditoria/; las validaciones futuras con documentación de tarea cumplirán el check.
