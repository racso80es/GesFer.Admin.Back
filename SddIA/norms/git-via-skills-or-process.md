...
- **Skill:** p. ej. paths.skillCapsules.invoke-command (interceptor de comandos de sistema), paths.skillCapsules.iniciar-rama, paths.skillCapsules.finalizar-proceso. Contrato: paths.skillsDefinitionPath/\<skill-id\>/spec.json.
...
- **Referencia en protocolo:** AGENTS.md, ley GIT y esta norma. Skills: paths.skillCapsules.invoke-command, paths.skillCapsules.iniciar-rama, paths.skillCapsules.finalizar-proceso.
