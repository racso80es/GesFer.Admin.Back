...
- **Skills (Git S+):** git-workspace-recon, git-branch-manager, git-save-snapshot, git-sync-remote, git-tactical-retreat, git-create-pr. Complemento: documentation, security-audit cuando aplique.
