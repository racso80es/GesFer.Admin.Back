...
- SEC-AUDIT-004: Execution must be logged to docs/audits/ACCESS_LOG.md regardless of outcome.
...
---
*Definición en paths.skillsDefinitionPath/security-audit/ (contrato SddIA/skills/skills-contract.md).*
